...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.reSetTable.setGeometry(QtCore.QRect(650, 440, 111, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.reSetTable.clicked.connect(Form.reSetTableStatus)
    ...
    def retranslateUi(self, Form):
        ...
        self.reSetTable.setText(_translate("Form", "重置桌子"))
