...
public:
	...
	//辅助函数
	void GetNextLineCard(BYTE cbIndexSatart, BYTE cbIndexEnd, BYTE cbLineCount, vector<BYTE> & lineArray, tagDistributingNew& Distributing, tagSearchCardResult *pSearchCardResult);
public:
	//组合算法
