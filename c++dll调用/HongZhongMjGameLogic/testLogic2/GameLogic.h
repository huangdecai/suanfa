...
#define CHR_PENG_PENG				0x00000020									//大对子
...
#define CHR_DA_DAN_DIAO     		0x00010000									//清龙七对
//////////////////////////////////////////////////////////////////////////
...
//数组说明
//vector<tagAnalyseItem> CAnalyseItemArray;
...
public:
	...
	//定缺
	BYTE SelectCallCard( BYTE cbCardIndex[MAX_INDEX] )const;
	//获得定缺牌
...
protected:
	...
	bool IsDaDanDiao(const BYTE cbCardIndex[]);
	//内部函数
private:
	//分析扑克																							  		
	bool AnalyseCard(const BYTE cbCardIndex[MAX_INDEX], const tagWeaveItem WeaveItem[], BYTE cbItemCount, vector<tagAnalyseItem>  &AnalyseItemArray);
	//排序,根据牌值排序
