...
public:
	...
	void ShiSanZhangOutCardCeLue(const BYTE cbHandCardData[], BYTE cbHandCardCount, BYTE  Array[DOU_NUM][DOU_HAND_COUNT], tagOutCardTypeResultNew * CardTypeResult, bool bChongSan);
