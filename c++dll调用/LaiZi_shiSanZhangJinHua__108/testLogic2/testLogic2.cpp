...
void TestGameLogic()
{
	...
	//BYTE    tempCard[] = {0x11, 0x29, 0x39, 0x3D, 0x3C, 0x38, 0x38, 0x32, 0x4F, 0x4E, 0x1A, 0x17, 0x07  };
	BYTE    tempCard[] = { 0x05, 0x34, 0x32, 0x3D, 0x1D, 0x3C, 0x2C, 0x0C, 0x3B, 0x3A, 0x39, 0x38, 0x37 };
