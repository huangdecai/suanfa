...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.LPlayer.setGeometry(QtCore.QRect(420, 210, 261, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.LPlayedCard.setGeometry(QtCore.QRect(0, 0, 261, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.RPlayer.setGeometry(QtCore.QRect(420, 280, 261, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        ...
        self.RPlayedCard.setGeometry(QtCore.QRect(0, 0, 261, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.ThreeLandlordCards.setGeometry(QtCore.QRect(70, 20, 331, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(16)
        font.setBold(False)
    ...
    def retranslateUi(self, Form):
        ...
        self.ThreeLandlordCards.setText(_translate("Form", "跑得快剩余牌区域"))
