...
class GameHelper:
    ...
    def GetCardsState(self, image,handCount):
        ...
        for i in range(0, handCount):
            ...
            checkSelect = 0
            result = LocateOnImage(imgCv, self.PicsCV["card_overlap"], region=(temp_x, spaceY - 30, spaceX, 30),
                                   confidence=0.85)
    ...
    def GetCards(self, image,handCount):
        ...
        for i in range(0, MAX_CARD_COUNT):
            ...
            checkSelect = 0
            result = LocateOnImage(imgCv, self.PicsCV["card_overlap"], region=(temp_x, spaceY-30, spaceX, 30), confidence=0.85)
            ...
            while ci < len(AllCardsNC):
                if "r" in AllCardsNC[ci] or "b" in AllCardsNC[ci]:
                    ...
                    result = LocateOnImage(imgCv, self.PicsCV["o" + AllCardsNC[ci]],
                                           region=(sx + spaceX * i, spaceY - checkSelect * 25, sw, 68), confidence=0.90)
