...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.WinRate.setGeometry(QtCore.QRect(450, 140, 201, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        ...
        self.WinRate.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.InitCard.setGeometry(QtCore.QRect(10, 360, 121, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.UserHandCards.setGeometry(QtCore.QRect(40, 160, 381, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.LPlayer.setGeometry(QtCore.QRect(320, 210, 361, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.LPlayedCard.setGeometry(QtCore.QRect(0, 0, 361, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.RPlayer.setGeometry(QtCore.QRect(320, 280, 361, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        ...
        self.RPlayedCard.setGeometry(QtCore.QRect(0, 0, 361, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.Player.setGeometry(QtCore.QRect(470, 70, 201, 61))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.ThreeLandlordCards.setGeometry(QtCore.QRect(40, 20, 331, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(16)
        font.setBold(False)
        ...
        self.Stop.setGeometry(QtCore.QRect(160, 360, 111, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.SwitchMode.setGeometry(QtCore.QRect(300, 360, 121, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.AutoStart.setGeometry(QtCore.QRect(450, 360, 111, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.jiaoDiZhuFen = QtWidgets.QLabel(Form)
        self.jiaoDiZhuFen.setGeometry(QtCore.QRect(50, 220, 241, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        ...
        font.setItalic(False)
        font.setWeight(50)
        self.jiaoDiZhuFen.setFont(font)
        self.jiaoDiZhuFen.setObjectName("jiaoDiZhuFen")
        self.QiangDiZhuFen = QtWidgets.QLabel(Form)
        self.QiangDiZhuFen.setGeometry(QtCore.QRect(50, 270, 241, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(12)
        font.setBold(False)
        font.setItalic(False)
        font.setWeight(50)
        self.QiangDiZhuFen.setFont(font)
        self.QiangDiZhuFen.setObjectName("QiangDiZhuFen")
        self.startlogin = QtWidgets.QPushButton(Form)
        self.startlogin.setGeometry(QtCore.QRect(570, 360, 111, 41))
        font = QtGui.QFont()
        font.setFamily("等线")
        font.setPointSize(14)
        font.setBold(False)
    ...
    def retranslateUi(self, Form):
        ...
        self.LPlayedCard.setText(_translate("Form", "对家已出牌区域"))
        self.RPlayedCard.setText(_translate("Form", "我家已出牌区域"))
        self.PredictedCard.setText(_translate("Form", "AI出牌区域"))
        self.ThreeLandlordCards.setText(_translate("Form", "剩余牌区域"))
        ...
        self.jiaoDiZhuFen.setText(_translate("Form", "叫地主分数 ："))
        self.QiangDiZhuFen.setText(_translate("Form", "抢地主分数："))
        self.startlogin.setText(_translate("Form", "开始登陆"))
